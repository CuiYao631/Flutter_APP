...
class _PersonTabState extends State<PersonTab> {
  ...
  void _changeDarkmode(bool flag){
    ...
    String afterTheme=Provider.of<ThemeSate>(context,listen: false).currentTheme.toString();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children:<Widget>[
          Container(
            child:Icon(Iconkit.Message,size: 20,),
    ...
    return Container(
      ...
      child: Row(
        ...
        children:<Widget> [
          ...
          Container(
            child: Image.asset('assets/images/login.png',width: 80,fit: BoxFit.cover,),
          ),
        ],
      ),
      ...
      child: Row(
        ...
        children:<Widget> [
          Column(
            ...
            children: <Widget>[
              Container(
                child: Text("小崔",style: Theme.of(context).textTheme.headline1,),
              ),
              GestureDetector(
                child: Container(
                  child: Text('查看并编辑个人资料',style:Theme.of(context).textTheme.headline2.copyWith(
          ...
          Stack(
            ...
            children: <Widget>[
              ...
              Text("小",style: Theme.of(context).textTheme.headline1.copyWith(
      ...
      children: <Widget>[
        ...
        Container(
            ...
            child: GestureDetector(
              ...
              onTap:(){
                HttpKit.post("/version", {},
                (data){
                  final snackbar=SnackBar(content: Text("版本信息：V_1.0.1"),);
